...
Signed: kim ye chan  Section: 02   Student Number: 21600120
*/
...
int binary_search(int *list, int key, int size, int check);
   ...
   while(1) {
      ...
      case 9:
         ...
         while (1) {
            ...
            if (N <= 0) break;
            pwr = GetInt("\tEnter a power number(0 to quit): ");
            if (pwr <= 0) break;
            cout << "\tpowerN(" << N << ", " << pwr << ") = " << powerN(N, pwr) << endl;
         }
         break;
      ...
      case 10:
         ...
         while (1) {
            ...
            int index = binary_search(list, key, N, check);
